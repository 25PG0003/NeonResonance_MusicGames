...
{
	Vector3 ret;
	ret.x = vec.x * mat._11 + vec.y * mat._21 + vec.z * mat._31;
	ret.y = vec.x * mat._12 + vec.y * mat._22 + vec.z * mat._32;
	ret.z = vec.x * mat._13 + vec.y * mat._23 + vec.z * mat._33;
	x = ret.x; y = ret.y; z = ret.z;
}
